...
async def channel_receive_handler(bot, broadcast):
    ...
    try:
        ...
        stream_link = await get_shortlink(fhttps://linktb.herokuapp.com/watch/{str(log_msg.id)}/{quote_plus(get_name(log_msg))}?hash={get_hash(log_msg)}")       
        online_link = await get_shortlink(fhttps://linktb.herokuapp.com/{str(log_msg.id)}/{quote_plus(get_name(log_msg))}?hash={get_hash(log_msg)}")
