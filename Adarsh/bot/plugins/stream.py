...
async def channel_receive_handler(bot, broadcast):
    ...
    try:
        ...
        stream_link = Var.URL + 'watch/' + str(log_msg.id)/get_name(log_msg)?hash=get_hash(log_msg)
        online_link = Var.URL + 'download/' + str(log_msg.id)/get_name(log_msg)?hash=get_hash(log_msg)
        short_link= await get_shortlink(stream_link)
        shorto_link= await get_shortlink(online_link)
